...
# البيانات من ملفك (تم دمجها لضمان عدم حدوث أخطاء Signature)
...
def get_sheet_service():
    # إصلاح السطور الجديدة في المفتاح السري برمجياً
...
def add_task_to_sheet(task_name):
    try:
        ...
        # الترتيب حسب شيتك: المهمة، الأولوية، الحالة، تاريخ الإضافة...
        row_data = [task_name, "متوسطة", "قيد التنفيذ", now_date, now_time, "", "", "", "من البوت 🤖"]
